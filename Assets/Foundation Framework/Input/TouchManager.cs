...
namespace FoundationFramework.MultiplatformInput
{
	...
	{
		[SerializeField] private LayerMask _pickedObjectLayers;
		...
		private void AddFinger(int index, Vector2 screenPosition)
		{
			...
			if (finger == null)
			{
				...
				finger.PickedGameobject = TryFindObject(screenPosition);
		...
		private GameObject TryFindObject(Vector3 screenPosition)
		{
			//TODO raycast and return the found object
			return null;
		}
	}
}